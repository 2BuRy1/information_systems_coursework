...
- нету входа по email/пароль. Критичность 2/5, тк есть вход через гугл и github: \
    Требование было убрано, то это не было отражено в спецификации.
...
- Приглашение участника реализовано в основном как invite-ссылка. Приглашение по email из сценария/формулировки не поддержано UI. 2/5: \
    Не реализовано в силу отсутствия регистрации через email/пароль
...
- Производительность (15 пользователей, 95–200мс, снапшот ≤1с) требование никак не проверяется: \
    Требование не корретно в силу отстутсивя нужного количества респондентов для проверки данного требования
